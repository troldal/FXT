...
int main()
{
    ...
    auto exp2 = exp1 | fxt::mtuple_append(std::string{"hello"});

    // Append a double value
    auto exp3 = exp2 | fxt::mtuple_append(3.14);
    ...
    auto result_with_error = error_exp
        | fxt::mtuple_append(std::string{"this won't be added"})
        | fxt::mtuple_append(999);
    ...
    auto combined = exp_tuple | fxt::mtuple_append(exp_value);
    ...
    auto opt2 = opt1 | fxt::mtuple_append(std::string{"hello"});
    auto opt3 = opt2 | fxt::mtuple_append(3.14);
    ...
    auto result_with_empty = empty_opt
        | fxt::mtuple_append(std::string{"won't be added"})
        | fxt::mtuple_append(999);
    ...
    auto combined_opt = opt_tuple | fxt::mtuple_append(opt_value);
    ...
    auto result_empty = tuple_opt | fxt::mtuple_append(empty_value);
    ...
    auto flat_exp2 = flat_exp1 | fxt::mtuple_append(std::string{"hello"});

    // Append a double value
    auto flat_exp3 = flat_exp2 | fxt::mtuple_append(3.14);
    ...
    auto chained_flat = fxt::expected<fxt::flat_tuple<int>, std::string>{fxt::flat_tuple<int>{100}}
        | fxt::mtuple_append(std::string{"flat"})
        | fxt::mtuple_append(2.71)
        | fxt::mtuple_append(true);
    ...
    auto flat_opt2 = flat_opt1 | fxt::mtuple_append(std::string{"flat_optional"});
    auto flat_opt3 = flat_opt2 | fxt::mtuple_append(1.618);
    ...
    auto combined_flat = flat_exp_tuple | fxt::mtuple_append(flat_exp_value);
