...
TEST_CASE("append - fxt::expected with plain values (flat_tuple)", "[append][flat_tuple]")
{
...
TEST_CASE("append - fxt::expected with error propagation (flat_tuple)", "[append][flat_tuple]")
{
    SECTION("error in initial expected")
    {
...
TEST_CASE("append - fxt::expected with expected values (flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append successful expected to flat_tuple")
    {
    ...
    SECTION("chain multiple expected values")
    {
        auto exp_tuple = fxt::expected<fxt::flat_tuple<int>, std::string>{fxt::flat_tuple<int>{1}};
        auto exp_val1 = fxt::expected<int, std::string>{2};
        auto exp_val2 = fxt::expected<int, std::string>{3};
        auto exp_val3 = fxt::expected<int, std::string>{4};
...
TEST_CASE("append - fxt::optional with plain values (flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append int to flat_tuple")
    {
    ...
    SECTION("append different types")
    {
        ...
        REQUIRE(fxt::get<1>(*result) == "optional");
        REQUIRE(fxt::get<2>(*result) == 1.41);
        REQUIRE(fxt::get<3>(*result) == false);
    }
}

TEST_CASE("append - fxt::optional with empty propagation (flat_tuple)", "[append][flat_tuple]")
{
    SECTION("empty initial optional")
    {
...
TEST_CASE("append - fxt::optional with optional values (flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append successful optional to flat_tuple")
    {
    ...
    SECTION("chain multiple optional values")
    {
        auto opt_tuple = fxt::optional<fxt::flat_tuple<int>>{fxt::flat_tuple<int>{1}};
        auto opt_val1 = fxt::optional<int>{2};
        auto opt_val2 = fxt::optional<int>{3};
        auto opt_val3 = fxt::optional<int>{4};
...
TEST_CASE("append - mixed plain and monadic values (expected, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append plain then expected value")
    {
        auto exp = fxt::expected<fxt::flat_tuple<int>, std::string>{fxt::flat_tuple<int>{1}};
...
TEST_CASE("append - mixed plain and monadic values (optional, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append plain then optional value")
    {
...
TEST_CASE("append - rvalue references (expected, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append with rvalue expected")
    {
...
TEST_CASE("append - rvalue references (optional, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append with rvalue optional")
    {
...
TEST_CASE("append - move-only types (expected, flat_tuple)", "[append][flat_tuple]")
{
...
TEST_CASE("append - move-only types (optional, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append unique_ptr to flat_tuple")
    {
        auto opt = fxt::optional<fxt::flat_tuple<int>>{fxt::flat_tuple<int>{42}};
...
TEST_CASE("append - complex types (expected, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append vector to flat_tuple")
    {
        auto exp = fxt::expected<fxt::flat_tuple<int>, std::string>{fxt::flat_tuple<int>{42}};
        std::vector<int> vec{1, 2, 3};
        auto result = exp | fxt::append(vec);
        ...
        REQUIRE(result.has_value());
        REQUIRE(fxt::get<0>(*result) == 42);
        REQUIRE(fxt::get<1>(*result).size() == 3);
        REQUIRE(fxt::get<1>(*result)[0] == 1);
    }

    SECTION("append pair to flat_tuple")
    {
        auto exp = fxt::expected<fxt::flat_tuple<int>, std::string>{fxt::flat_tuple<int>{42}};
        ...
        REQUIRE(result.has_value());
        REQUIRE(fxt::get<0>(*result) == 42);
        REQUIRE(fxt::get<1>(*result).first == 10);
        REQUIRE(fxt::get<1>(*result).second == "test");
    }
}

TEST_CASE("append - complex types (optional, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append vector to flat_tuple")
    {
        auto opt = fxt::optional<fxt::flat_tuple<int>>{fxt::flat_tuple<int>{42}};
...
TEST_CASE("append - const correctness (expected, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append to const expected")
    {
...
TEST_CASE("append - const correctness (optional, flat_tuple)", "[append][flat_tuple]")
{
    SECTION("append to const optional")
    {
...
TEST_CASE("append - type deduction (flat_tuple)", "[append][flat_tuple]")
{
    SECTION("auto deduction with expected")
    {
        auto exp = fxt::expected<fxt::flat_tuple<int>, std::string>{fxt::flat_tuple<int>{42}};
...
TEST_CASE("append - edge cases (flat_tuple)", "[append][flat_tuple]")
{
...
TEST_CASE("append - comparison std::tuple vs flat_tuple", "[append][flat_tuple]")
{
    SECTION("behavior equivalence with expected")
    {
        ...
        REQUIRE(std::get<0>(*std_result) == fxt::get<0>(*flat_result));
        REQUIRE(std::get<1>(*std_result) == fxt::get<1>(*flat_result));
        REQUIRE(std::get<2>(*std_result) == fxt::get<2>(*flat_result));
    }

    SECTION("behavior equivalence with optional")
    {
        auto std_result = fxt::optional<std::tuple<int>>{std::tuple{5}}
            | fxt::append(15) | fxt::append(25);
