...
int main() {
    // Test apply patterns for fxt::flat_tuple
    auto t1 = fxt::make_flat_tuple(1, 2, 3);
    auto t2 = fxt::make_flat_tuple(4, 5, 6, 7);
    auto t3 = fxt::make_flat_tuple(8, 9, 10, 11, 12);
    ...
    auto r6 = fxt::apply([](auto a, auto b, auto c) {
        auto sum = a + b + c;
        auto prod = a * b * c;
        return fxt::make_flat_tuple(sum, prod);
    }, t1);
